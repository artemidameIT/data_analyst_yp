...
|11             |[Анализ и сегментация клиентов регионального банка по количеству потребляемых продуктов](https://github.com/artemidameIT/data_analyst_yp/tree/main/Bank_segment_scoring)|Выявить признаки, наиболее влияющие на отток и дать рекомендации для улучшения деятельности банка|
|12             |[Провести оценку результатов A/B-теста. Датасет с действиями пользователей, техническое задание и несколько вспомогательных датасетов](https://github.com/artemidameIT/data_analyst_yp/tree/main/AB_Gr)|Оценить корректность проведения теста и проанализировать результаты теста|
